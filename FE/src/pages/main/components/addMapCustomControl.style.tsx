...
.radius_border{border:1px solid #fff;border-radius:5px;}     
.custom_typecontrol {position:absolute;top:50px;right:10px;overflow:hidden;width:130px;height:30px;margin:0;padding:0;z-index:1;font-size:12px;font-family:'Malgun Gothic', '맑은 고딕', sans-serif;}
